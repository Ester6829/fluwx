...
class MethodChannelFluwx extends FluwxPlatform {
  ...
  Future<bool> open(OpenType target) async {
    switch (target) {
      ...
      case BusinessView():
        return await methodChannel.invokeMethod("openBusinessView", target.arguments) ??
            false;
      case Invoice():
        return await methodChannel.invokeMethod("openWeChatInvoice", target.arguments) ??
            false;
      case CustomerServiceChat():
        return await methodChannel.invokeMethod(
            ...
            false;
      case MiniProgram():
        return await methodChannel.invokeMethod('launchMiniProgram', target.arguments) ??
            false;
  ...
  Future<bool> openBusinessView({
    ...
    final result = await methodChannel.invokeMethod<bool>('openBusinessView', {
